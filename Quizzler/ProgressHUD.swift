...
extension AlertIcon {
	...
	var image: UIImage? {
		switch self {
        case .heart:		if #available(iOS 13.0, *) {
            return UIImage(systemName: "heart.fill")
        } else {
            // Fallback on earlier versions
        }
        case .doc:			if #available(iOS 13.0, *) {
            return UIImage(systemName: "doc.fill")
        } else {
            // Fallback on earlier versions
        }
        case .bookmark:		if #available(iOS 13.0, *) {
            return UIImage(systemName: "bookmark.fill")
        } else {
            // Fallback on earlier versions
        }
        case .moon:			if #available(iOS 13.0, *) {
            return UIImage(systemName: "moon.fill")
        } else {
            // Fallback on earlier versions
        }
        case .star:			if #available(iOS 13.0, *) {
            return UIImage(systemName: "star.fill")
        } else {
            // Fallback on earlier versions
        }
        case .exclamation:	if #available(iOS 13.0, *) {
            return UIImage(systemName: "exclamationmark.triangle.fill")
        } else {
            // Fallback on earlier versions
        }
        case .flag:			if #available(iOS 13.0, *) {
            return UIImage(systemName: "flag.fill")
        } else {
            // Fallback on earlier versions
        }
        case .message:		if #available(iOS 13.0, *) {
            return UIImage(systemName: "envelope.fill")
        } else {
            // Fallback on earlier versions
        }
        case .question:		if #available(iOS 13.0, *) {
            return UIImage(systemName: "questionmark.diamond.fill")
        } else {
            // Fallback on earlier versions
        }
        case .bolt:			if #available(iOS 13.0, *) {
            return UIImage(systemName: "bolt.fill")
        } else {
            // Fallback on earlier versions
        }
        case .shuffle:		if #available(iOS 13.0, *) {
            return UIImage(systemName: "shuffle")
        } else {
            // Fallback on earlier versions
        }
        case .eject:		if #available(iOS 13.0, *) {
            return UIImage(systemName: "eject.fill")
        } else {
            // Fallback on earlier versions
        }
        case .card:			if #available(iOS 13.0, *) {
            return UIImage(systemName: "creditcard.fill")
        } else {
            // Fallback on earlier versions
        }
        case .rotate:		if #available(iOS 13.0, *) {
            return UIImage(systemName: "rotate.right.fill")
        } else {
            // Fallback on earlier versions
        }
        case .like:			if #available(iOS 13.0, *) {
            return UIImage(systemName: "hand.thumbsup.fill")
        } else {
            // Fallback on earlier versions
        }
        case .dislike:		if #available(iOS 13.0, *) {
            return UIImage(systemName: "hand.thumbsdown.fill")
        } else {
            // Fallback on earlier versions
        }
        case .privacy:		if #available(iOS 13.0, *) {
            return UIImage(systemName: "hand.raised.fill")
        } else {
            // Fallback on earlier versions
        }
        case .cart:			if #available(iOS 13.0, *) {
            return UIImage(systemName: "cart.fill")
        } else {
            // Fallback on earlier versions
        }
        case .search:		if #available(iOS 13.0, *) {
